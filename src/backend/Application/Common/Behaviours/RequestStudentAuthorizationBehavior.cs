...
{
    public class RequestStudentAuthorizationBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
            where TRequest : IRequest<TResponse>
    {
        private readonly IAuthTokenService _authTokenService;
        private readonly ICallContext _context;
        private readonly IStudentIdentityService _identityService;
        private readonly UserType _accessibleBy = UserType.STUDENT;

        public RequestStudentAuthorizationBehavior(ICallContext context,
            IAuthTokenService authTokenService, IStudentIdentityService identityService)
        {
            _context = context;
