...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220329154316_Initial13")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Course", b =>
                {
                    ...
                    b.Property<double>("PriceInTFuel")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Domain.Entities.CourseLessonOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.CourseSubscription", b =>
                {
                    ...
                    b.Property<double?>("AmountCashout")
                        .HasColumnType("float");

                    b.Property<string>("BuyTx")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");

                    b.Property<string>("CashoutPaymentTx")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.Property<double?>("PriceBurn")
                        .HasColumnType("float");

                    b.Property<double?>("PriceDev")
                        .HasColumnType("float");

                    b.Property<int?>("Rating")
                        .HasColumnType("int");

                    b.Property<string>("SendToBurnTx")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");

                    b.Property<string>("SendToDevTx")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Domain.Views.InstructorCourseSubscriptionViewItem", b =>
                {
                    b.Property<double?>("AmountBurn")
                        .HasColumnType("float");

                    b.Property<double?>("AmountCashout")
                        .HasColumnType("float");

                    b.Property<string>("BurnTx")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("StudentProfilePictureUri")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ViewLessons")
                        .HasColumnType("int");

                    b.ToView("InstructorCourseSubscriptionView");
                });
            ...
            modelBuilder.Entity("Domain.Views.StudentCourseSubscriptionPurchaseViewItem", b =>
                {
                    ...
                    b.Property<string>("InstructorProfilePictureFilename")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("StudentCourseSubscriptionPurchaseView");
                });

            modelBuilder.Entity("Domain.Views.StudentCourseSubscriptionViewItem", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int");
                    ...
                    b.ToView("StudentCourseSubscriptionView");
                });

            modelBuilder.Entity("Domain.Views.StudentCourseViewItem", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int");
                    ...
                    b.Property<double>("CourseAverageRating")
                        .HasColumnType("float");

                    b.Property<DateTime>("CourseCreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<int>("CourseEnrolledCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CourseListingStatus")
                        .HasColumnType("int");

                    b.Property<string>("CourseName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("CoursePriceInTFuel")
                        .HasColumnType("float");

                    b.Property<int>("CourseRatingCount")
                        .HasColumnType("int");

                    b.Property<string>("CourseShortDescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CourseThumbnailImageUri")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("InstructorProfilePictureUri")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("StudentCourseView");
                });

            modelBuilder.Entity("Domain.Views.StudentEnrolledCourseViewItem", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int");
                    ...
                    b.ToView("StudentEnrolledCourseView");
                });
            ...
            modelBuilder.Entity("Domain.Entities.CourseLessonOrder", b =>
                {
                    b.HasOne("Domain.Entities.CourseLesson", "Lesson")
                        .WithMany()
