...
namespace WebApi.Base
{
    public abstract class HttpFunctionBase
    {
        ...
        protected void EnsureUserTypeAuthorization(HttpRequest httpRequest, UserType accessibleBy)
        {
            SetUserAuthorization(httpRequest);
            Context.AccesibleBy = accessibleBy;
        }

        private void SetUserAuthorization(HttpRequest httpRequest)
        {
