...
namespace Client.App.Infrastructure.Managers
{
    public class ManagerToolkit : IManagerToolkit
    {
        ...
        public async Task SaveProfile(InstructorMyProfileDto data) => await _localStorage.SetItemAsync(StorageConstants.Local.Profile, data);
        public async Task<InstructorMyProfileDto> GetProfile()
        {
            var data = await _localStorage.GetItemAsync<InstructorMyProfileDto>(StorageConstants.Local.Profile);
            return data;
        }
